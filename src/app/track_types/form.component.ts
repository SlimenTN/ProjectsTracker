...
@Component({
  selector: 'app-interventions-type-form',
  templateUrl: 'form.component.html',
  providers: [TrackTypesService]
})
export class InterventionsTypeFormComponent implements OnInit{
  title: string;
  form: FormGroup;
  id: number = null;
  ...
  constructor(private fb: FormBuilder,
              ...
              private _service: TrackTypesService,
  ...
  initForm(): void{
    this._activatedRoute.params.subscribe((params: Params) => {
      ...
      if (id !== undefined) {
        ...
        this.title = 'Ajout d\'un nouveau type d\'intervention';
      }
    });
  }
    ...
    if (this.id == null) {
      ...
      this._service.create(type).subscribe(response => {
        if (response.persisted) {
          this._router.navigate(['/types-interventions']);
